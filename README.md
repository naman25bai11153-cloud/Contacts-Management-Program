...
3 → Delete a contact number

4 → Update Contact details 

5 → Search Contact number or name 

6 → Search name assosiated with a contact number

7 → Add additional details like DOB, Email, Address or notes 

8 → Search additional details for a particular contact 
